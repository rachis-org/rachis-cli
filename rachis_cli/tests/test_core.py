...
from rachis_cli.core.config import CLIConfig
from rachis_cli.core.usage import ReplayCLIUsage, CLIUsageVariable
...
class TestOption(unittest.TestCase):
    def setUp(self):
        ...
        self.path = os.path.join(rachis_cli.util.get_app_dir(),
                                 'cli-colors.theme')
    ...
    def test_repeated_eager_option_with_callback(self):
        result = self.runner.invoke(
            rachis_cli.builtin.tools.tools,
            ['list-types', '--tsv', '--tsv'])
